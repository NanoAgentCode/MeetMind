...
from .models import Meeting, MeetingAnswer, MeetingQuestion, Minutes
from .chat_service import answer_meeting_question
...
app.include_router(create_chat_router(lambda: store, lambda: model_registry, require_meeting))
